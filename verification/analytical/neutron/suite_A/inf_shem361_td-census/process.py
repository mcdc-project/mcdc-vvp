...
tool.plot_convergence("inf_shem361_td_census_flux", N_particle_list, error, error_max)
tool.plot_convergence("inf_shem361_td_census_n", N_particle_list, error_n, error_max_n)
