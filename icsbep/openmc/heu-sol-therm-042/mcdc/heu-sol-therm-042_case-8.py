...
m1 = mcdc.material(nuclides=[
	['U235',3.2367e-05],
	['U238',1.8936000000000002e-06],
	['N14',0.00013387],
	['H1',0.066362],
	['O16',0.033607258019999996],
	['O17',1.274198e-05]])
...
# Surface(s)
s1 = mcdc.surface('cylinder-z', center=[0.0, 0.0], radius=136.779, bc='interface')
s2 = mcdc.surface('cylinder-z', center=[0.0, 0.0], radius=138.684, bc='vacuum')
s3 = mcdc.surface('plane-z', z=-1.905, bc='vacuum')
s4 = mcdc.surface('plane-z', z=0.0, bc='interface')
s5 = mcdc.surface('plane-z', z=241.046, bc='interface')
s6 = mcdc.surface('plane-z', z=274.32, bc='vacuum')
