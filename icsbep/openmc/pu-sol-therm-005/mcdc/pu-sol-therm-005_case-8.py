...
m1 = mcdc.material(nuclides=[
	['Pu239',7.3646e-05],
	['Pu240',3.3753999999999995e-06],
	['N14',0.0012286],
	['H1',0.063977],
	['O16',0.035214],
	['Fe54',6.807087e-08],
	['Fe56',1.068567084e-06],
	['Fe57',2.4677874000000004e-08],
	['Fe58',3.2841720000000005e-09]])
...
# Surface(s)
s1 = mcdc.surface('sphere', center=[0.0, 0.0, 0.0], radius=17.7865, bc='interface')
s2 = mcdc.surface('sphere', center=[0.0, 0.0, 0.0], radius=17.9135, bc='interface')
s3 = mcdc.surface('sphere', center=[0.0, 0.0, 0.0], radius=47.9135, bc='vacuum')
