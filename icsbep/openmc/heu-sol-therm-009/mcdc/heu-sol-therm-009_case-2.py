...
# Surface(s)
s1 = mcdc.surface('sphere', center=[0.0, 0.0, 0.0], radius=11.4695, bc='interface')
s2 = mcdc.surface('sphere', center=[0.0, 0.0, 0.0], radius=11.5282, bc='interface')
