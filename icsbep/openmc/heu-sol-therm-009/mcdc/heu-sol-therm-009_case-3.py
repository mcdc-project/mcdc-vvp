...
m1 = mcdc.material(nuclides=[
	['U235',0.0008328099999999999],
	['U238',4.7124e-05],
	['F19',0.0017864],
	['O16',0.033454316006999996],
	['O17',1.2683992999999998e-05],
	['H1',0.063362]])
...
m2 = mcdc.material(nuclides=[
	...
	['Zn70',1.522438e-07],
	['Mn55',1.4853e-05]])
# Material Name: Water Reflector at 25 C
# S(a,b): c_H_in_H2O (Not Implemented)
...
# Surface(s)
s1 = mcdc.surface('sphere', center=[0.0, 0.0, 0.0], radius=11.5177, bc='interface')
s2 = mcdc.surface('sphere', center=[0.0, 0.0, 0.0], radius=11.6764, bc='interface')
