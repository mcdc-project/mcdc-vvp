...
# Surface(s)
s1 = mcdc.surface('sphere', center=[0.0, 0.0, 0.0], radius=19.3163, bc='interface')
s2 = mcdc.surface('sphere', center=[0.0, 0.0, 0.0], radius=19.4382, bc='vacuum')
