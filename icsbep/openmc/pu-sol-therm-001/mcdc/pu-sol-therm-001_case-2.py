...
# Surface(s)
s1 = mcdc.surface('sphere', center=[0.0, 0.0, 0.0], radius=14.5377, bc='interface')
s2 = mcdc.surface('sphere', center=[0.0, 0.0, 0.0], radius=14.6622, bc='interface')
s3 = mcdc.surface('sphere', center=[0.0, 0.0, 0.0], radius=44.6622, bc='vacuum')
