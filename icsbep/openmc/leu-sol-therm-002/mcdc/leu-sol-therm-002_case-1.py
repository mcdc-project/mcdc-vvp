...
# Surface(s)
s1 = mcdc.surface('sphere', center=[0.0, 0.0, 0.0], radius=34.399, bc='interface')
s2 = mcdc.surface('sphere', center=[0.0, 0.0, 0.0], radius=34.5578, bc='interface')
s3 = mcdc.surface('sphere', center=[0.0, 0.0, 0.0], radius=49.5578, bc='vacuum')
