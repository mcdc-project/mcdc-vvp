...
# Surface(s)
s1 = mcdc.surface('sphere', center=[0.0, 0.0, 0.0], radius=34.671, bc='interface')
s2 = mcdc.surface('sphere', center=[0.0, 0.0, 0.0], radius=34.8298, bc='interface')
s3 = mcdc.surface('sphere', center=[0.0, 0.0, 0.0], radius=49.8298, bc='vacuum')
s4 = mcdc.surface('plane-z', z=16.7413, bc='interface')

# Material Cell(s)
c1 = mcdc.cell(-s1 & -s4, fill=m1)
c2 = mcdc.cell(+s1 & -s2, fill=m2)
c3 = mcdc.cell(-s1 & +s4, fill=mvoid)
