...
# Material Name: Berylium Reflector
# S(a,b): c_Be (Not Implemented)
m2 = mcdc.material(nuclides=[
	['Be9',0.12099],
	['O16',0.0010445039829000001],
	['O17',3.9601710000000004e-07]])
...
# Surface(s)
s1 = mcdc.surface('plane-z', z=-17.345, bc='vacuum')
s2 = mcdc.surface('plane-z', z=-2.45, bc='interface')
s3 = mcdc.surface('plane-z', z=-2.43, bc='interface')
s4 = mcdc.surface('plane-z', z=-2.25, bc='interface')
s5 = mcdc.surface('plane-z', z=-1.98, bc='interface')
s6 = mcdc.surface('plane-z', z=-1.94, bc='interface')
s7 = mcdc.surface('plane-z', z=-1.49, bc='interface')
s8 = mcdc.surface('plane-z', z=-1.45, bc='interface')
s9 = mcdc.surface('plane-z', z=-1.0, bc='interface')
s10 = mcdc.surface('plane-z', z=-0.96, bc='interface')
s11 = mcdc.surface('plane-z', z=-0.51, bc='interface')
s12 = mcdc.surface('plane-z', z=-0.47, bc='interface')
s13 = mcdc.surface('plane-z', z=-0.02, bc='interface')
s14 = mcdc.surface('plane-z', z=0.0, bc='interface')
s15 = mcdc.surface('plane-z', z=0.01, bc='interface')
s16 = mcdc.surface('plane-z', z=0.03, bc='interface')
s17 = mcdc.surface('plane-z', z=0.48, bc='interface')
s18 = mcdc.surface('plane-z', z=0.52, bc='interface')
s19 = mcdc.surface('plane-z', z=0.97, bc='interface')
s20 = mcdc.surface('plane-z', z=1.01, bc='interface')
s21 = mcdc.surface('plane-z', z=1.46, bc='interface')
s22 = mcdc.surface('plane-z', z=1.5, bc='interface')
s23 = mcdc.surface('plane-z', z=1.95, bc='interface')
s24 = mcdc.surface('plane-z', z=1.99, bc='interface')
s25 = mcdc.surface('plane-z', z=2.26, bc='interface')
s26 = mcdc.surface('plane-z', z=2.44, bc='interface')
s27 = mcdc.surface('plane-z', z=2.46, bc='interface')
s28 = mcdc.surface('plane-z', z=2.48, bc='interface')
s29 = mcdc.surface('plane-z', z=17.375, bc='vacuum')
