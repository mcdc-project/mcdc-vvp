...
# Material Name: Water with 1384 PPM Boron
...
m4 = mcdc.material(nuclides=[
	['O16',0.023036],
	['Al27',0.015357]])
# Material Name: Cladding for Al2O3 Perturbing Rods
m5 = mcdc.material(nuclides=[
	['Mg24',0.0005281663998],
	['Mg25',6.703179599999999e-05],
	['Mg26',7.37818042e-05],
	['Al27',0.058183],
	['Si28',0.000320369016448],
	['Si29',1.6267424576e-05],
	['Si30',1.0723558976e-05],
	['Ti46',4.2024675e-06],
	['Ti47',3.7898616e-06],
	['Ti48',3.75522308e-05],
	['Ti49',2.7557999e-06],
	...
	['Fe57',4.318522e-06],
	['Fe58',5.74716e-07],
	['Cu63',4.4233871999999993e-05],
	['Cu65',1.9734127999999998e-05],
	['Zn64',3.05660388e-05],
	['Zn66',1.7238077199999997e-05],
	['Zn67',2.5114256e-06],
	['Zn68',1.1469257999999999e-05],
	['Zn70',3.792004e-07]])
...
c51 = mcdc.cell(-s6, fill=m4)
c52 = mcdc.cell(+s6 & -s7, fill=m5)
c53 = mcdc.cell(+s7, fill=m1)
