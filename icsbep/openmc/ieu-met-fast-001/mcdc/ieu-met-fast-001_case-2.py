...
s148 = mcdc.surface('plane-z', z=15.488, bc='vacuum')
...
# Material Cell(s)
c1 = mcdc.cell(+s101 & -s148 & -s2, fill=mvoid)
...
c64 = mcdc.cell(+s129 & -s131 & +s2 & -s10, fill=m1)
c65 = mcdc.cell(+s131 & -s134 & +s2 & -s12, fill=m2)
c66 = mcdc.cell(+s134 & -s136 & +s2 & -s12, fill=m1)
c67 = mcdc.cell(+s136 & -s138 & +s2 & -s12, fill=m2)
c68 = mcdc.cell(+s138 & -s140 & +s2 & -s12, fill=m1)
c69 = mcdc.cell(+s140 & -s142 & +s2 & -s12, fill=m2)
c70 = mcdc.cell(+s142 & -s144 & +s2 & -s12, fill=m1)
c71 = mcdc.cell(+s144 & -s146 & +s2 & -s12, fill=m2)
c72 = mcdc.cell(+s146 & -s148 & +s2 & -s12, fill=m1)
c103 = mcdc.cell(+s129 & -s131 & +s10 & -s17, fill=m3)
...
c121 = mcdc.cell(-s21 & +s17 & -s148 & +s202, fill=mvoid)
c124 = mcdc.cell(-s148 & +s131 & +s12 & -s17, fill=mvoid)
