...
s179 = mcdc.surface('plane-z', z=25.552, bc='interface')
s180 = mcdc.surface('plane-z', z=26.005, bc='vacuum')
...
# Material Cell(s)
c1 = mcdc.cell(+s101 & -s180 & -s2, fill=mvoid)
c51 = mcdc.cell(+s101 & -s103 & +s2 & -s12, fill=m1)
c52 = mcdc.cell(+s103 & -s106 & +s2 & -s12, fill=m2)
c53 = mcdc.cell(+s106 & -s108 & +s2 & -s12, fill=m1)
c54 = mcdc.cell(+s108 & -s109 & +s2 & -s12, fill=m1)
c55 = mcdc.cell(+s109 & -s112 & +s2 & -s12, fill=m2)
c56 = mcdc.cell(+s112 & -s114 & +s2 & -s12, fill=m1)
c57 = mcdc.cell(+s114 & -s115 & +s2 & -s12, fill=m1)
c58 = mcdc.cell(+s115 & -s118 & +s2 & -s12, fill=m2)
c59 = mcdc.cell(+s118 & -s120 & +s2 & -s12, fill=m1)
c60 = mcdc.cell(+s120 & -s121 & +s2 & -s12, fill=m1)
c61 = mcdc.cell(+s121 & -s124 & +s2 & -s12, fill=m2)
c62 = mcdc.cell(+s124 & -s126 & +s2 & -s12, fill=m1)
c63 = mcdc.cell(+s126 & -s127 & +s2 & -s12, fill=m1)
c64 = mcdc.cell(+s127 & -s130 & +s2 & -s12, fill=m2)
c65 = mcdc.cell(+s130 & -s132 & +s2 & -s12, fill=m1)
c66 = mcdc.cell(+s132 & -s133 & +s2 & -s12, fill=m1)
c67 = mcdc.cell(+s133 & -s136 & +s2 & -s12, fill=m2)
c68 = mcdc.cell(+s136 & -s138 & +s2 & -s12, fill=m1)
c69 = mcdc.cell(+s138 & -s139 & +s2 & -s12, fill=m1)
c70 = mcdc.cell(+s139 & -s142 & +s2 & -s12, fill=m2)
c71 = mcdc.cell(+s142 & -s144 & +s2 & -s12, fill=m1)
c72 = mcdc.cell(+s144 & -s146 & +s2 & -s10, fill=m1)
c73 = mcdc.cell(+s146 & -s149 & +s2 & -s12, fill=m2)
c74 = mcdc.cell(+s149 & -s151 & +s2 & -s12, fill=m1)
c75 = mcdc.cell(+s151 & -s153 & +s2 & -s12, fill=m1)
c76 = mcdc.cell(+s153 & -s155 & +s2 & -s12, fill=m2)
c77 = mcdc.cell(+s155 & -s157 & +s2 & -s12, fill=m1)
c78 = mcdc.cell(+s157 & -s159 & +s2 & -s12, fill=m1)
c79 = mcdc.cell(+s159 & -s161 & +s2 & -s12, fill=m2)
c80 = mcdc.cell(+s161 & -s163 & +s2 & -s12, fill=m1)
c81 = mcdc.cell(+s163 & -s165 & +s2 & -s12, fill=m1)
c82 = mcdc.cell(+s165 & -s167 & +s2 & -s12, fill=m2)
c83 = mcdc.cell(+s167 & -s169 & +s2 & -s12, fill=m1)
c84 = mcdc.cell(+s169 & -s171 & +s2 & -s12, fill=m1)
c85 = mcdc.cell(+s171 & -s173 & +s2 & -s12, fill=m2)
c86 = mcdc.cell(+s173 & -s175 & +s2 & -s12, fill=m1)
c87 = mcdc.cell(+s175 & -s177 & +s2 & -s12, fill=m1)
c88 = mcdc.cell(+s177 & -s179 & +s2 & -s12, fill=m2)
c89 = mcdc.cell(+s179 & -s180 & +s2 & -s12, fill=m1)
...
c121 = mcdc.cell(-s21 & +s12 & -s180 & +s146, fill=mvoid)
