...
# Surface(s)
s1 = mcdc.surface('sphere', center=[0.0, 0.0, 0.0], radius=27.9244, bc='interface')
s2 = mcdc.surface('sphere', center=[0.0, 0.0, 0.0], radius=28.1244, bc='interface')
s3 = mcdc.surface('sphere', center=[0.0, 0.0, 0.0], radius=43.1244, bc='vacuum')
