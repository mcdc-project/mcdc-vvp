...
# Surface(s)
s1 = mcdc.surface('sphere', center=[0.0, 0.0, 0.0], radius=19.633, bc='interface')
s2 = mcdc.surface('sphere', center=[0.0, 0.0, 0.0], radius=19.735, bc='interface')
s3 = mcdc.surface('sphere', center=[0.0, 0.0, 0.0], radius=44.373, bc='interface')
s4 = mcdc.surface('sphere', center=[0.0, 0.0, 0.0], radius=44.627, bc='vacuum')
