...
m1 = mcdc.material(nuclides=[
	['U235',0.00047399000000000003],
	['U238',2.6635999999999997e-05],
	['F19',0.0010116],
	['O16',0.033064463817000005],
	['O17',1.2536183e-05],
	['H2',0.063939],
	['H1',0.00019239]])
...
# Surface(s)
s1 = mcdc.surface('sphere', center=[0.0, 0.0, 0.0], radius=20.874, bc='interface')
s2 = mcdc.surface('sphere', center=[0.0, 0.0, 0.0], radius=20.976, bc='interface')
s3 = mcdc.surface('sphere', center=[0.0, 0.0, 0.0], radius=44.344, bc='interface')
s4 = mcdc.surface('sphere', center=[0.0, 0.0, 0.0], radius=44.598, bc='vacuum')
