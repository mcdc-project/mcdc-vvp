...
m1 = mcdc.material(nuclides=[
	...
	['F19',0.00032809],
	['O16',0.033443320176],
	['O17',1.2679823999999999e-05],
	['H2',0.066058],
	['H1',0.00019877000000000002]])
...
# Surface(s)
s1 = mcdc.surface('sphere', center=[0.0, 0.0, 0.0], radius=23.419, bc='interface')
s2 = mcdc.surface('sphere', center=[0.0, 0.0, 0.0], radius=23.52, bc='interface')
s3 = mcdc.surface('sphere', center=[0.0, 0.0, 0.0], radius=44.348, bc='interface')
s4 = mcdc.surface('sphere', center=[0.0, 0.0, 0.0], radius=44.602, bc='vacuum')
