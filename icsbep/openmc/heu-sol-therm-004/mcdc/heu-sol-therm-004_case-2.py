...
# Surface(s)
s1 = mcdc.surface('sphere', center=[0.0, 0.0, 0.0], radius=18.401, bc='interface')
s2 = mcdc.surface('sphere', center=[0.0, 0.0, 0.0], radius=18.503, bc='interface')
