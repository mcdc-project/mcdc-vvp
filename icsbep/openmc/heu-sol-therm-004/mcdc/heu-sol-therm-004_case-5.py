...
m1 = mcdc.material(nuclides=[
	...
	['F19',0.0005687],
	['O16',0.032931514224],
	['O17',1.2485776000000003e-05],
	['H2',0.064556],
	['H1',0.00019424999999999998]])
...
# Surface(s)
s1 = mcdc.surface('sphere', center=[0.0, 0.0, 0.0], radius=22.211, bc='interface')
s2 = mcdc.surface('sphere', center=[0.0, 0.0, 0.0], radius=22.313, bc='interface')
s3 = mcdc.surface('sphere', center=[0.0, 0.0, 0.0], radius=44.411, bc='interface')
s4 = mcdc.surface('sphere', center=[0.0, 0.0, 0.0], radius=44.665, bc='vacuum')
