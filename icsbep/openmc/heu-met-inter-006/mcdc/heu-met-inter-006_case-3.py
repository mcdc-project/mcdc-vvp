...
s3 = mcdc.surface('plane-z', z=19.61496, bc='interface')
s4 = mcdc.surface('plane-z', z=25.96496, bc='interface')
s5 = mcdc.surface('plane-z', z=40.39216, bc='interface')
s6 = mcdc.surface('plane-z', z=42.40688, bc='interface')
s7 = mcdc.surface('plane-z', z=42.7066, bc='interface')
s8 = mcdc.surface('plane-z', z=44.72132, bc='interface')
s9 = mcdc.surface('plane-z', z=46.73604, bc='interface')
s10 = mcdc.surface('plane-z', z=47.03576, bc='interface')
s11 = mcdc.surface('plane-z', z=49.05048, bc='interface')
s12 = mcdc.surface('plane-z', z=51.0652, bc='interface')
s13 = mcdc.surface('plane-z', z=51.36492, bc='interface')
s14 = mcdc.surface('plane-z', z=53.37964, bc='interface')
s15 = mcdc.surface('plane-z', z=55.39436, bc='interface')
s16 = mcdc.surface('plane-z', z=55.69408, bc='interface')
s17 = mcdc.surface('plane-z', z=57.7088, bc='interface')
s18 = mcdc.surface('plane-z', z=59.72352, bc='interface')
s19 = mcdc.surface('plane-z', z=60.02324, bc='interface')
s20 = mcdc.surface('plane-z', z=62.03796, bc='interface')
s21 = mcdc.surface('plane-z', z=64.05268, bc='interface')
s22 = mcdc.surface('plane-z', z=64.3524, bc='interface')
s23 = mcdc.surface('plane-z', z=66.36712, bc='interface')
s24 = mcdc.surface('plane-z', z=68.38184, bc='interface')
s25 = mcdc.surface('plane-z', z=68.68156, bc='interface')
s26 = mcdc.surface('plane-z', z=70.69628, bc='interface')
s27 = mcdc.surface('plane-z', z=72.711, bc='interface')
s28 = mcdc.surface('plane-z', z=73.01072, bc='interface')
s29 = mcdc.surface('plane-z', z=75.02544, bc='interface')
s30 = mcdc.surface('plane-z', z=77.04016, bc='interface')
s31 = mcdc.surface('plane-z', z=77.33988, bc='interface')
s32 = mcdc.surface('plane-z', z=79.3546, bc='interface')
s33 = mcdc.surface('plane-z', z=79.59725, bc='interface')
s34 = mcdc.surface('plane-z', z=94.02445, bc='interface')
...
# Material Cell(s)
c1 = mcdc.cell(+s1 & -s17 & -s36, fill=mvoid)
c2 = mcdc.cell(+s1 & -s17 & +s36 & -s37, fill=m4)
c3 = mcdc.cell(+s1 & -s17 & +s37 & -s38, fill=mvoid)
...
c19 = mcdc.cell(+s14 & -s15 & +s38 & -s41, fill=m2)
c20 = mcdc.cell(+s15 & -s16 & +s38 & -s41, fill=m1)
c21 = mcdc.cell(+s16 & -s17 & +s38 & -s41, fill=m2)
