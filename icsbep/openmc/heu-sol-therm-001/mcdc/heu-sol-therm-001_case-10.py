...
# Surface(s)
s1 = mcdc.surface('cylinder-z', center=[0.0, 0.0], radius=25.345, bc='interface')
s2 = mcdc.surface('cylinder-z', center=[0.0, 0.0], radius=25.665, bc='vacuum')
s3 = mcdc.surface('plane-z', z=-0.64, bc='vacuum')
s4 = mcdc.surface('plane-z', z=0.0, bc='interface')
s5 = mcdc.surface('plane-z', z=20.48, bc='interface')
s6 = mcdc.surface('plane-z', z=30.9, bc='vacuum')
