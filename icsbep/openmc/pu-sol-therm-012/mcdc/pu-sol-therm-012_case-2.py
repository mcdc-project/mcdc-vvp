...
# Material Name: Plutonium nitrate solution (17.7 g/L)
...
m1 = mcdc.material(nuclides=[
	...
	['Pu242',5.02795e-07],
	['Am241',2.69732e-07],
	['N14',0.0013797374409700001],
	['N15',5.07255903e-06],
	['O16',0.035362392571799996],
	['O17',1.34074282e-05],
	['H1',0.0636291],
	['Fe54',2.58414464e-07],
	['Fe56',4.0565544447999995e-06],
	['Fe57',9.368353279999999e-08],
	['Fe58',1.2467558399999998e-08],
	['Cr50',6.177373400000001e-08],
	['Cr52',1.1912449708e-06],
	['Cr53',1.350776172e-07],
	['Cr54',3.3623678e-08],
	['Ni58',6.8597688285e-07],
	['Ni60',2.6423706715e-07],
	['Ni61',1.148620235e-08],
	['Ni62',3.662303925e-08],
	['Ni64',9.3268084e-09]])
# Material Name: Air
...
s24 = mcdc.surface('plane-z', z=32.25, bc='interface')
s25 = mcdc.surface('plane-z', z=33.25, bc='interface')
s26 = mcdc.surface('plane-z', z=51.25, bc='interface')
s27 = mcdc.surface('plane-z', z=52.25, bc='interface')
