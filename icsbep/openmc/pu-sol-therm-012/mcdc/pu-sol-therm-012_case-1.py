...
# Material Name: Plutonium nitrate solution (19.7 g/L)
...
m1 = mcdc.material(nuclides=[
	...
	['Pu242',5.59608e-07],
	['Am241',3.0021e-07],
	['N14',0.00140826256928],
	['N15',5.17743072e-06],
	['O16',0.0353798859393],
	['O17',1.3414060700000003e-05],
	['H1',0.0634983],
	['Fe54',2.89928366e-07],
	['Fe56',4.5512553112e-06],
	['Fe57',1.0510833319999998e-07],
	['Fe58',1.39879896e-08],
	['Cr50',6.93075295e-08],
	['Cr52',1.3365267179000001e-06],
	['Cr53',1.515514011e-07],
	['Cr54',3.7724351500000005e-08],
	['Ni58',7.696365852600001e-07],
	['Ni60',2.9646263474000003e-07],
	['Ni61',1.288702546e-08],
	['Ni62',4.10894763e-08],
	['Ni64',1.046427824e-08]])
# Material Name: Air
...
s24 = mcdc.surface('plane-z', z=28.17, bc='interface')
s25 = mcdc.surface('plane-z', z=29.17, bc='interface')
s26 = mcdc.surface('plane-z', z=47.17, bc='interface')
s27 = mcdc.surface('plane-z', z=48.17, bc='interface')
