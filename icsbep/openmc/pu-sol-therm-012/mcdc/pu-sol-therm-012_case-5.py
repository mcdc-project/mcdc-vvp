...
# Material Name: Plutonium nitrate solution (13.2 g/L)
...
m1 = mcdc.material(nuclides=[
	...
	['Pu242',3.74965e-07],
	['Am241',2.01156e-07],
	['N14',0.0013666256460500002],
	['N15',5.024353950000001e-06],
	['O16',0.035287720883100004],
	['O17',1.3379116900000002e-05],
	['H1',0.0635948],
	['Fe54',2.07991987e-07],
	['Fe56',3.2650293884000003e-06],
	['Fe57',7.54037674e-08],
	['Fe58',1.0034857200000001e-08],
	['Cr50',4.972026950000001e-08],
	['Cr52',9.588059059e-07],
	['Cr53',1.087208931e-07],
	['Cr54',2.7062931500000002e-08],
	['Ni58',5.52129528222e-07],
	['Ni60',2.1267930577800002e-07],
	['Ni61',9.245022161999999e-09],
	['Ni62',2.9477176110000006e-08],
	['Ni64',7.506967728000001e-09]])
# Material Name: Air
...
s24 = mcdc.surface('plane-z', z=66.15, bc='interface')
s25 = mcdc.surface('plane-z', z=67.15, bc='interface')
s26 = mcdc.surface('plane-z', z=85.15, bc='interface')
s27 = mcdc.surface('plane-z', z=86.15, bc='interface')
