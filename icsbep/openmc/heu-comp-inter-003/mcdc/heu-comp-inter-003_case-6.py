...
s11 = mcdc.surface('plane-z', z=9.1622, bc='interface')
s12 = mcdc.surface('plane-z', z=9.1876, bc='interface')
s13 = mcdc.surface('plane-z', z=12.1832, bc='interface')
s14 = mcdc.surface('plane-z', z=12.2086, bc='interface')
s15 = mcdc.surface('plane-z', z=12.234, bc='interface')
s16 = mcdc.surface('plane-z', z=15.2061, bc='interface')
s17 = mcdc.surface('plane-z', z=15.2315, bc='interface')
s18 = mcdc.surface('plane-z', z=15.3903, bc='interface')
s19 = mcdc.surface('plane-z', z=17.7303, bc='interface')
...
s28 = mcdc.surface('cylinder-z', center=[0.0, 0.0], radius=10.0609, bc='vacuum')
