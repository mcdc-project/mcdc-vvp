...
m1 = mcdc.material(nuclides=[
	['U235',0.0001244],
	['U238',7.039299999999999e-06],
	['F19',0.00026684],
	['O16',0.033414331166999996],
	['O17',1.2668833000000002e-05],
	['H1',0.06632]])
...
# Surface(s)
s1 = mcdc.surface('sphere', center=[0.0, 0.0, 0.0], radius=15.9569, bc='interface')
s2 = mcdc.surface('sphere', center=[0.0, 0.0, 0.0], radius=16.0839, bc='interface')
