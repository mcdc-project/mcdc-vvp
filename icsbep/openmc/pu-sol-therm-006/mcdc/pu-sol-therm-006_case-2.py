...
m1 = mcdc.material(nuclides=[
	...
	['H1',0.063492],
	['O16',0.035444],
	['Fe54',5.9244920000000006e-08],
	['Fe56',9.30018544e-07],
	['Fe57',2.1478183999999998e-08],
	['Fe58',2.858352e-09]])
...
# Surface(s)
s1 = mcdc.surface('sphere', center=[0.0, 0.0, 0.0], radius=19.0416, bc='interface')
s2 = mcdc.surface('sphere', center=[0.0, 0.0, 0.0], radius=19.1686, bc='interface')
s3 = mcdc.surface('sphere', center=[0.0, 0.0, 0.0], radius=49.1686, bc='vacuum')
