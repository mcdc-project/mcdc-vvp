...
m1 = mcdc.material(nuclides=[
	...
	['U238',1.3607e-05],
	['F19',0.00052267],
	['O16',0.033384342537000004],
	['O17',1.2657462999999999e-05],
	['H1',0.065749]])
...
m2 = mcdc.material(nuclides=[
	...
	['Zn70',1.522438e-07],
	['Mn55',1.4853e-05]])
# Material Name: Water Reflector at 27.5 C
# S(a,b): c_H_in_H2O (Not Implemented)
m3 = mcdc.material(nuclides=[
	['H1',0.066614],
	['O16',0.033294376647],
	['O17',1.2623353000000002e-05]])
...
# Surface(s)
s1 = mcdc.surface('sphere', center=[0.0, 0.0, 0.0], radius=13.2123, bc='interface')
s2 = mcdc.surface('sphere', center=[0.0, 0.0, 0.0], radius=13.3393, bc='interface')
