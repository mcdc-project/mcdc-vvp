...
m2 = mcdc.material(nuclides=[
	...
	['Zn70',1.522438e-07],
	['Mn55',1.4853e-05]])
# Material Name: Water Reflector at 85.5 C
# S(a,b): c_H_in_H2O (Not Implemented)
...
# Surface(s)
s1 = mcdc.surface('sphere', center=[0.0, 0.0, 0.0], radius=13.2418, bc='interface')
s2 = mcdc.surface('sphere', center=[0.0, 0.0, 0.0], radius=13.3688, bc='interface')
