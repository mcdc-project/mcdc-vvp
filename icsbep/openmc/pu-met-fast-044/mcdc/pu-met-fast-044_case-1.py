...
m4 = mcdc.material(nuclides=[
	['Mo100',0.0061191345599999995],
	['Mo92',0.00919942551],
	['Mo94',0.005769344129999999],
	['Mo95',0.00996808527],
	['Mo96',0.010470477269999999],
	['Mo97',0.006017400179999999],
	['Mo98',0.015255133079999999]])
# Material Name: Polyethylene
# S(a,b): c_H_in_CH2 (Not Implemented)
m5 = mcdc.material(nuclides=[
	['C0',0.03967],
	['H1',0.0793276435884],
	['H2',1.2356411599999999e-05]])
...
s6 = mcdc.surface('sphere', center=[0.0, 0.0, 0.0], radius=8.8975, bc='vacuum')
