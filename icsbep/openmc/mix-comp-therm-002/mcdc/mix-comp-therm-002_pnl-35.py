...
m4 = mcdc.material(nuclides=[
	['H1',0.066682],
	['O16',0.03339233950499999],
	['O17',1.2660494999999998e-05],
	['B10',8.4597e-06],
	['B11',3.4266e-05]])
...
s25 = mcdc.surface('cylinder-z', center=[0.0, 0.0], radius=70.0, bc='vacuum')
...
s37 = mcdc.surface('plane', A=1.0, B=-1.0, C=0.0, D=1.48174226, bc='interface')
s38 = mcdc.surface('plane', A=1.0, B=-1.0, C=0.0, D=1.03272945, bc='interface')
s39 = mcdc.surface('plane', A=1.0, B=-1.0, C=0.0, D=-1.48174226, bc='interface')
s40 = mcdc.surface('plane', A=1.0, B=-1.0, C=0.0, D=-1.03272945, bc='interface')
s41 = mcdc.surface('plane', A=1.0, B=1.0, C=0.0, D=-1.48174226, bc='interface')
s42 = mcdc.surface('plane', A=1.0, B=1.0, C=0.0, D=-1.03272945, bc='interface')
s43 = mcdc.surface('plane', A=1.0, B=1.0, C=0.0, D=1.48174226, bc='interface')
s44 = mcdc.surface('plane', A=1.0, B=1.0, C=0.0, D=1.03272945, bc='interface')
...
c27 = mcdc.cell(+s5 & -s8 & -s37 & +s38, fill=m5)
c28 = mcdc.cell(+s5 & -s8 & +s39 & -s40, fill=m5)
c29 = mcdc.cell(+s5 & -s8 & -s38 & +s40 & +s41 & -s42, fill=m5)
c30 = mcdc.cell(+s5 & -s8 & -s38 & +s40 & -s43 & +s44, fill=m5)
c31 = mcdc.cell(+s5 & -s8 & -s38 & +s40 & +s42 & -s44 & +s36, fill=m4)
c32 = mcdc.cell(+s5 & -s8 & +s37, fill=m4)
c33 = mcdc.cell(+s5 & -s8 & -s39, fill=m4)
c34 = mcdc.cell(+s5 & -s8 & -s41, fill=m4)
c35 = mcdc.cell(+s5 & -s8 & +s43, fill=m4)
c36 = mcdc.cell(+s8 & -s9 & +s36, fill=m4)
c37 = mcdc.cell(+s9 & -s10 & -s37 & +s38, fill=m5)
c38 = mcdc.cell(+s9 & -s10 & +s39 & -s40, fill=m5)
c39 = mcdc.cell(+s9 & -s10 & -s38 & +s40 & +s41 & -s42, fill=m5)
c40 = mcdc.cell(+s9 & -s10 & -s38 & +s40 & -s43 & +s44, fill=m5)
c41 = mcdc.cell(+s9 & -s10 & -s38 & +s40 & +s42 & -s44 & +s36, fill=m4)
c42 = mcdc.cell(+s9 & -s10 & +s37, fill=m4)
c43 = mcdc.cell(+s9 & -s10 & -s39, fill=m4)
c44 = mcdc.cell(+s9 & -s10 & -s41, fill=m4)
c45 = mcdc.cell(+s9 & -s10 & +s43, fill=m4)
c46 = mcdc.cell(+s10 & +s36, fill=m4)
c51 = mcdc.cell(-s5, fill=m4)
c52 = mcdc.cell(+s5 & -s8 & -s37 & +s38, fill=m5)
c53 = mcdc.cell(+s5 & -s8 & +s39 & -s40, fill=m5)
c54 = mcdc.cell(+s5 & -s8 & -s38 & +s40 & +s41 & -s42, fill=m5)
c55 = mcdc.cell(+s5 & -s8 & -s38 & +s40 & -s43 & +s44, fill=m5)
c56 = mcdc.cell(+s5 & -s8 & -s38 & +s40 & +s42 & -s44, fill=m4)
c57 = mcdc.cell(+s5 & -s8 & +s37, fill=m4)
c58 = mcdc.cell(+s5 & -s8 & -s39, fill=m4)
c59 = mcdc.cell(+s5 & -s8 & -s41, fill=m4)
c60 = mcdc.cell(+s5 & -s8 & +s43, fill=m4)
c61 = mcdc.cell(+s8 & -s9, fill=m4)
c62 = mcdc.cell(+s9 & -s10 & -s37 & +s38, fill=m5)
c63 = mcdc.cell(+s9 & -s10 & +s39 & -s40, fill=m5)
c64 = mcdc.cell(+s9 & -s10 & -s38 & +s40 & +s41 & -s42, fill=m5)
c65 = mcdc.cell(+s9 & -s10 & -s38 & +s40 & -s43 & +s44, fill=m5)
c66 = mcdc.cell(+s9 & -s10 & -s38 & +s40 & +s42 & -s44, fill=m4)
c67 = mcdc.cell(+s9 & -s10 & +s37, fill=m4)
c68 = mcdc.cell(+s9 & -s10 & -s39, fill=m4)
c69 = mcdc.cell(+s9 & -s10 & -s41, fill=m4)
c70 = mcdc.cell(+s9 & -s10 & +s43, fill=m4)
c71 = mcdc.cell(+s10, fill=m4)
# Root Universe Cells List:
u0_cells = []
# Material Universe(s)

# Rectangular Lattice 11
Lattice11 = mcdc.lattice(x=[-1.257235, 2.51447, 29], y=[-1.257235, 2.51447, 29], 