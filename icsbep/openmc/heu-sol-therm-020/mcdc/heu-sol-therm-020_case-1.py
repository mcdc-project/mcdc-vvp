...
s3 = mcdc.surface('plane-z', z=71.45, bc='interface')
...
s8 = mcdc.surface('cylinder-z', center=[0.0, 0.0], radius=31.6, bc='interface')
s9 = mcdc.surface('cylinder-z', center=[0.0, 0.0], radius=31.9175, bc='vacuum')
