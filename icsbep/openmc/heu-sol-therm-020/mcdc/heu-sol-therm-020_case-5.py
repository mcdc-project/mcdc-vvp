...
s3 = mcdc.surface('plane-z', z=84.75, bc='interface')
s4 = mcdc.surface('plane-z', z=121.92, bc='interface')
s5 = mcdc.surface('plane-z', z=122.8725, bc='vacuum')
s6 = mcdc.surface('cylinder-z', center=[0.0, 0.0], radius=1.27, bc='interface')
s7 = mcdc.surface('cylinder-z', center=[0.0, 0.0], radius=1.42875, bc='interface')
...
c7 = mcdc.cell(+s2 & -s5 & +s6 & -s7, fill=m4)
