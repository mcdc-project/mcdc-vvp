...
m1 = mcdc.material(nuclides=[
	...
	['N14',0.00011212],
	['H1',0.066409],
	['O16',0.033588265220999995],
	['O17',1.2734778999999998e-05]])
...
# Surface(s)
s1 = mcdc.surface('sphere', center=[0.0, 0.0, 0.0], radius=61.011, bc='interface')
s2 = mcdc.surface('sphere', center=[0.0, 0.0, 0.0], radius=61.786, bc='vacuum')
