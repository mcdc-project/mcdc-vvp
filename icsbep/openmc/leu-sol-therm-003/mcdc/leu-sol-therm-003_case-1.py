...
m1 = mcdc.material(nuclides=[
	...
	['U238',0.00067271],
	['N14',0.0023185],
	['O16',0.037458797732999996],
	['O17',1.4202266999999998e-05],
	['H1',0.05885399999999999]])
...
# Surface(s)
s1 = mcdc.surface('sphere', center=[0.0, 0.0, 0.0], radius=32.9537, bc='interface')
s2 = mcdc.surface('sphere', center=[0.0, 0.0, 0.0], radius=33.1037, bc='vacuum')
s3 = mcdc.surface('plane-z', z=16.4073, bc='interface')

# Material Cell(s)
c1 = mcdc.cell(-s1 & -s3, fill=m1)
c2 = mcdc.cell(-s1 & +s3, fill=mvoid)
