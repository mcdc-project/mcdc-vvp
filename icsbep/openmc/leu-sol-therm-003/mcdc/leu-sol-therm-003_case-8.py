...
m1 = mcdc.material(nuclides=[
	...
	['N14',0.0013661],
	['O16',0.035854406028],
	['O17',1.3593971999999999e-05],
	['H1',0.06230700000000001]])
...
# Surface(s)
s1 = mcdc.surface('sphere', center=[0.0, 0.0, 0.0], radius=59.8897, bc='interface')
s2 = mcdc.surface('sphere', center=[0.0, 0.0, 0.0], radius=60.0997, bc='vacuum')
s3 = mcdc.surface('plane-z', z=41.934, bc='interface')
