...
m1 = mcdc.material(nuclides=[
	...
	['H1',0.060707],
	['O16',0.037228],
	['Fe54',1.2416533500000002e-07],
	['Fe56',1.9491302220000003e-06],
	['Fe57',4.5013917000000005e-08],
	['Fe58',5.990526000000001e-09]])
...
# Surface(s)
s1 = mcdc.surface('sphere', center=[0.0, 0.0, 0.0], radius=15.3399, bc='interface')
s2 = mcdc.surface('sphere', center=[0.0, 0.0, 0.0], radius=15.4669, bc='interface')
s3 = mcdc.surface('sphere', center=[0.0, 0.0, 0.0], radius=45.4669, bc='vacuum')
