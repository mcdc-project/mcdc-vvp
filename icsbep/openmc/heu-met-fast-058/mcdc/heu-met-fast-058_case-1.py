...
# Material Name: Beryllium (internal)
...
s4 = mcdc.surface('sphere', center=[0.0, 0.0, 0.0], radius=5.1805, bc='interface')
s5 = mcdc.surface('sphere', center=[0.0, 0.0, 0.0], radius=25.4497, bc='vacuum')
