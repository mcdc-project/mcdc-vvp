...
s4 = mcdc.surface('sphere', center=[0.0, 0.0, 0.0], radius=4.6975, bc='interface')
s5 = mcdc.surface('sphere', center=[0.0, 0.0, 0.0], radius=7.1105, bc='interface')
s6 = mcdc.surface('sphere', center=[0.0, 0.0, 0.0], radius=17.7505, bc='vacuum')
