...
s20 = mcdc.surface('plane-z', z=1.11, bc='interface')
s21 = mcdc.surface('plane-z', z=1.31, bc='interface')
s22 = mcdc.surface('plane-z', z=1.91, bc='interface')
s23 = mcdc.surface('plane-z', z=2.09, bc='interface')
s24 = mcdc.surface('plane-z', z=2.58, bc='interface')
s25 = mcdc.surface('plane-z', z=4.57, bc='interface')
s26 = mcdc.surface('plane-z', z=5.06, bc='interface')
s27 = mcdc.surface('plane-z', z=7.03, bc='interface')
s28 = mcdc.surface('plane-z', z=7.52, bc='interface')
s29 = mcdc.surface('plane-z', z=9.51, bc='interface')
s30 = mcdc.surface('plane-z', z=10.0, bc='interface')
s31 = mcdc.surface('plane-z', z=11.97, bc='interface')
s32 = mcdc.surface('plane-z', z=12.46, bc='interface')
s33 = mcdc.surface('plane-z', z=14.45, bc='interface')
s34 = mcdc.surface('plane-z', z=14.94, bc='interface')
s35 = mcdc.surface('plane-z', z=16.91, bc='interface')
s36 = mcdc.surface('plane-z', z=17.4, bc='interface')
s37 = mcdc.surface('plane-z', z=19.39, bc='interface')
s38 = mcdc.surface('plane-z', z=19.88, bc='interface')
s39 = mcdc.surface('plane-z', z=21.85, bc='interface')
s40 = mcdc.surface('plane-z', z=22.34, bc='vacuum')
...
# Material Cell(s)
c1 = mcdc.cell(+s1 & -s2 & -s51, fill=m5)
c2 = mcdc.cell(+s2 & -s3 & -s51, fill=m2)
c3 = mcdc.cell(+s3 & -s4 & -s51, fill=m5)
c4 = mcdc.cell(+s4 & -s5 & -s51, fill=m1)
c5 = mcdc.cell(+s5 & -s6 & -s51, fill=m5)
c6 = mcdc.cell(+s6 & -s7 & -s51, fill=m2)
c7 = mcdc.cell(+s7 & -s8 & -s51, fill=m5)
c8 = mcdc.cell(+s8 & -s9 & -s51, fill=m1)
c9 = mcdc.cell(+s9 & -s10 & -s51, fill=m5)
c10 = mcdc.cell(+s10 & -s11 & -s51, fill=m2)
c11 = mcdc.cell(+s11 & -s12 & -s51, fill=m5)
c12 = mcdc.cell(+s12 & -s13 & -s51, fill=m1)
c13 = mcdc.cell(+s13 & -s14 & -s51, fill=m5)
c14 = mcdc.cell(+s14 & -s15 & -s51, fill=m2)
c15 = mcdc.cell(+s15 & -s16 & -s51, fill=m5)
c16 = mcdc.cell(+s16 & -s17 & -s51, fill=m1)
c17 = mcdc.cell(+s17 & -s18 & -s51, fill=m5)
...
c22 = mcdc.cell(+s23 & -s24 & -s51, fill=m5)
c23 = mcdc.cell(+s24 & -s25 & -s51, fill=m1)
c24 = mcdc.cell(+s25 & -s26 & -s51, fill=m5)
c25 = mcdc.cell(+s26 & -s27 & -s51, fill=m2)
c26 = mcdc.cell(+s27 & -s28 & -s51, fill=m5)
c27 = mcdc.cell(+s28 & -s29 & -s51, fill=m1)
c28 = mcdc.cell(+s29 & -s30 & -s51, fill=m5)
c29 = mcdc.cell(+s30 & -s31 & -s51, fill=m2)
c30 = mcdc.cell(+s31 & -s32 & -s51, fill=m5)
c31 = mcdc.cell(+s32 & -s33 & -s51, fill=m1)
c32 = mcdc.cell(+s33 & -s34 & -s51, fill=m5)
c33 = mcdc.cell(+s34 & -s35 & -s51, fill=m2)
c34 = mcdc.cell(+s35 & -s36 & -s51, fill=m5)
c35 = mcdc.cell(+s36 & -s37 & -s51, fill=m1)
c36 = mcdc.cell(+s37 & -s38 & -s51, fill=m5)
c37 = mcdc.cell(+s38 & -s39 & -s51, fill=m2)
c38 = mcdc.cell(+s39 & -s40 & -s51, fill=m5)
